...
This change is made to install a ETSO-2C112-approved Mode-S transponder (like for example the Garrecht VT-01 UltraCompact) with a Filser Transflex-4 antenna in the applicable aircraft. The design covers the installation of an antenna, a transponder and wiring. This change is identical for all effective aircraft.
